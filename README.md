...
This repository has been modified as an adhoc fork to allow using master code before release with the `gin-swagger` repository. All credit to the original authors.
...
- [Declarative Comments Format](#declarative-comments-format)
  ...
  - [Examples](#examples)
    ...
    - [Generate enum types from enum constants](#generate-enum-types-from-enum-constants)
    ...
    - [Parse Internal and Dependency Packages](#parse-internal-and-dependency-packages)
